...
.method public static findAllSubscriptionsInGroup(Landroid/telephony/SubscriptionManager;I)Ljava/util/List;
    ...
    new-instance p1, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$_l4yKsl-hclBlwjTeu4zLUT3_sU;

    invoke-direct {p1, v0}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$_l4yKsl-hclBlwjTeu4zLUT3_sU;-><init>(Landroid/os/ParcelUuid;)V
...
.method public static getSubById(Landroid/telephony/SubscriptionManager;I)Landroid/telephony/SubscriptionInfo;
    ...
    new-instance v0, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$vkG4uNuchFm_XOSO8aO8ejseRnA;

    invoke-direct {v0, p1}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$vkG4uNuchFm_XOSO8aO8ejseRnA;-><init>(I)V
...
.method public static getUniqueSubscriptionDisplayNames(Landroid/content/Context;)Ljava/util/Map;
    ...
    .line 245
    new-instance v1, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$qJWCO6_CyzUmo203bOBvKcBekm8;

    invoke-direct {v1, v0}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$qJWCO6_CyzUmo203bOBvKcBekm8;-><init>(Landroid/telephony/SubscriptionManager;)V
    ...
    new-instance v3, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$gwD-pqajkrIUcSuOPTB6hzrjZjY;

    invoke-direct {v3, v0}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$gwD-pqajkrIUcSuOPTB6hzrjZjY;-><init>(Ljava/util/Set;)V
    ...
    sget-object v3, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$XJU8QXEFNFsIjHNbuHEh0GrSUTw;->INSTANCE:Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$XJU8QXEFNFsIjHNbuHEh0GrSUTw;
    ...
    .line 266
    new-instance v3, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$ZoEyqB_y02PZeU9yV8aGUbs4HDc;

    invoke-direct {v3, v1, v2, p0}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$ZoEyqB_y02PZeU9yV8aGUbs4HDc;-><init>(Ljava/util/function/Supplier;Ljava/util/Set;Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$tPgagBu6zLU7aCWD6v1CXryDTBs;

    invoke-direct {v1, v0}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$tPgagBu6zLU7aCWD6v1CXryDTBs;-><init>(Ljava/util/Set;)V
    ...
    sget-object v0, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$zxBojrhmLM3IVGbFzLrB1fJWfE4;->INSTANCE:Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$zxBojrhmLM3IVGbFzLrB1fJWfE4;
    ...
    new-instance v1, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$ZCCponGsOw-G_FVeb9Lcn0SU4Eg;

    invoke-direct {v1, p0}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$ZCCponGsOw-G_FVeb9Lcn0SU4Eg;-><init>(Ljava/util/Set;)V

    invoke-interface {v0, v1}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object p0

    sget-object v0, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$pOoQH7M5m-_Cp3-XcTKdaczUhPg;->INSTANCE:Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$pOoQH7M5m-_Cp3-XcTKdaczUhPg;

    sget-object v1, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$CEFnT1eBBYOetUCrHeVhiTVHO_0;->INSTANCE:Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$CEFnT1eBBYOetUCrHeVhiTVHO_0;
...
.method static synthetic lambda$findAllSubscriptionsInGroup$12(Landroid/os/ParcelUuid;Landroid/telephony/SubscriptionInfo;)Z
    .locals 1
...
.method static synthetic lambda$getSubById$11(ILandroid/telephony/SubscriptionInfo;)Z
    .locals 0
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$0(Landroid/telephony/SubscriptionInfo;)Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;
    .locals 1
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$1(Landroid/telephony/SubscriptionManager;)Ljava/util/stream/Stream;
    .locals 1
    ...
    sget-object v0, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$9x2o4P11_VWD3hIhLLxUAsm6oJw;->INSTANCE:Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$9x2o4P11_VWD3hIhLLxUAsm6oJw;
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$10(Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Ljava/lang/CharSequence;
    .locals 0
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$2(Ljava/util/Set;Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Z
    .locals 0
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$3(Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Ljava/lang/CharSequence;
    .locals 0
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$4(Ljava/util/Set;Landroid/content/Context;Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;
    .locals 1
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$5(Ljava/util/function/Supplier;Ljava/util/Set;Landroid/content/Context;)Ljava/util/stream/Stream;
    .locals 1
    ...
    new-instance v0, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$McvIXS1_rpgk1Clr8hnYEn4twmM;

    invoke-direct {v0, p1, p2}, Lcom/android/settings/network/-$$Lambda$SubscriptionUtil$McvIXS1_rpgk1Clr8hnYEn4twmM;-><init>(Ljava/util/Set;Landroid/content/Context;)V
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$6(Ljava/util/Set;Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Z
    .locals 0
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$7(Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Ljava/lang/CharSequence;
    .locals 0
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$8(Ljava/util/Set;Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;
    .locals 1
...
.method static synthetic lambda$getUniqueSubscriptionDisplayNames$9(Lcom/android/settings/network/SubscriptionUtil$1DisplayInfo;)Ljava/lang/Integer;
    .locals 0
